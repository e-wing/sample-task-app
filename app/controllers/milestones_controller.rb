class MilestonesController < ApplicationController
  ...
  private
    ...
    params.require(:milestone).permit(:id, :name, :project_id, :milestone_template_id, :project_id,
      task_attributes: [:id, :name, :milestone_id, :task_template_id, :project_id, :_destroy])
    end
end
